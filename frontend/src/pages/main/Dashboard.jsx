...

          {
            workspaces.data?.workspaces?.length > 0 ?
              <div>
                ...
                <div>
                  {
                    workspaces?.data?.workspaces?.map(({ name, spreadsheets, forms, gallery, updatedAt }) => (
                      <div>
                        ...
                        <div className='py-[24px] gap-[24px] flex flex-row flex-wrap'>
                          <WorkspaceItemCard type={'spreadsheets'} time={updatedAt} />
                          <WorkspaceItemCard type={'forms'} time={updatedAt} />
                          <WorkspaceItemCard type={'gallery'} time={updatedAt} />
