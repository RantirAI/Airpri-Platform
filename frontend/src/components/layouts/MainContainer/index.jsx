...
const MainContainer = ({ children }) => {
    ...
    return (
        <div className=' flex flex-col bg-[rgb(249,250,251)] dark:bg-[#101016] '>
            ...
            <div className={`min-h-screen w-full ${showLeftPane ? 'lg:w-[85%] lg:left-[15%]' : 'lg:w-full'} left-0  relative pt-16 flex flex-col px-[10px] lg:px-[20px] py-[10px] overflow-x-hidden`}>
                <div >
                    {children}
                </div>
                <Footer />
